...
class _BookCarState extends State<BookCar> {
  ...
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> bookings =
        FirebaseFirestore.instance.collection('bookcar').snapshots();
                            ...
                            child: ListTile(
                              ...
                              title: Row(
                                children: [
                                  ...
                                  ElevatedButton(
                                    onPressed: () async {
                                      FirebaseFirestore.instance.collection('cars').doc('${data.docs[index]['name'][0].toString()}').update({'status':'booked'});
                                    },
                                    child: const Padding(
