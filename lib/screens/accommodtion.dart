...
import 'show-images/acco_images.dart';

class AccomodationScreen extends StatefulWidget {
  const AccomodationScreen({Key? key}) : super(key: key);

  @override
  AccomodationScreenState createState() => AccomodationScreenState();
}

class AccomodationScreenState extends State<AccomodationScreen> {
  late String dateCount;
  late String range;

  final Stream<QuerySnapshot> accommodation =
